package exepciones.ejercicio.aprendizaje.pkg01.Entidad;
...
public class Persona {
 ...
 devuelve un booleano.
    ...
    public boolean esMayorDeEdad() throws Exception { //En caso de ocurrir una EXCEPCIONN, se ARROJA (THROWS) una excepción PERSONALIZADA
        
        boolean mayor = false;
        
        //-------------- PARTE NUEVA DE LA GUIA DE EXCEPCIONES
        
        //Valida si la edad es "NULL", como no se puede colocar NULL a un int, por defecto es 0, entonces para que tome la excepcióm con THROW NEW EXCEPYION (ARROJAR)
         if(this.edad==0){ 
